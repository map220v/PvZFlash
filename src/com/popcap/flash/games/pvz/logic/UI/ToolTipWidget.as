   ...
   public class ToolTipWidget
   {
      ...
      public function Draw(g:Graphics2D) : void
      {
         ...
         if(this.mTitle.length > 0)
         {
            ...
            aPosY = aPosY + (this.mFontBold.getAscent() + TOOLTIP_LINE_SPACING);
         }
         if(this.mWarningText.length > 0)
         {
            ...
            this.mFont.setColor(1,0,0,0);
            aPosY = aPosY + (this.mFont.getAscent() + TOOLTIP_LINE_SPACING);
         }
      ...
      public function CalculateSize() : void
      {
         ...
         if(this.mTitle.length > 0)
         {
            aHeight = aHeight + (this.mFont.getAscent() + TOOLTIP_LINE_SPACING);
         }
         if(this.mWarningText.length > 0)
         {
            aHeight = aHeight + (this.mFont.getAscent() + TOOLTIP_LINE_SPACING);
         }
         aHeight = aHeight + this.mFont.getAscent() * aLines.length;
      ...
      public function GetLines(theLines:Array) : void
      {
         ...
         var numWords:int = theWords.length;
