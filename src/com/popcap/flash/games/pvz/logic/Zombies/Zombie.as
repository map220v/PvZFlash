package com.popcap.flash.games.pvz.logic.Zombies
{
   ...
   public class Zombie extends GameObject
   {
      ...
      public function ZombieInitialize(theRow:int, theType:int, theVariant:Boolean, theParentZombie:Zombie, theFromWave:int, app:PVZApp, theBoard:Board) : void
      {
         ...
         if(mBoard && mBoard.IsFlagWave(this.mFromWave))
         {
      ...
      public function UpdatePlaying() : void
      {
         ...
         this.mGroanCounter--;
         var aZombiesOnScreen:int = mBoard.mZombies.length;
      ...
      public function GetZombieRect() : Rectangle
      {
         ...
         if(this.mHitRectUpdated == false)
         {
            ...
            if(aDrawPos.mClipHeight > CLIP_HEIGHT_LIMIT)
            {
               this.mZombieHitRect.height = this.mZombieHitRect.height - aDrawPos.mClipHeight;
            }
      ...
      public function ZombieTargetLeadX(theTime:Number) : Number
      {
         ...
         if(this.mChilledCounter > 0)
         {
            aSpeed = aSpeed * CHILLED_SPEED_FACTOR;
         }
         if(this.ZombieNotWalking())
         {
            aSpeed = 0;
      ...
      public function DrawReanim(g:Graphics2D, theDrawPos:ZombieDrawPosition) : void
      {
         ...
         if(this.mJustGotShotCounter > 0)
         {
            ...
            aExtraAdditiveColor.red = aExtraAdditiveColor.red > 1?Number(1):Number(aExtraAdditiveColor.red);
            aExtraAdditiveColor.green = aExtraAdditiveColor.green + aFade;
            aExtraAdditiveColor.green = aExtraAdditiveColor.green > 1?Number(1):Number(aExtraAdditiveColor.green);
            aExtraAdditiveColor.blue = aExtraAdditiveColor.blue + aFade;
            aExtraAdditiveColor.blue = aExtraAdditiveColor.blue > 1?Number(1):Number(aExtraAdditiveColor.blue);
            aEnableExtraAdditiveDraw = true;
         }
